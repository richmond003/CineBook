  ...
  useEffect(() => {
    const loadDetails = async () => {
      try {
        ...
        // get recommendations
        const recommendationsData = await getRecommendation(
          isMovie ? "movie" : "tv",
          id
        );
                  ...
                  <Button
                    ...
                    startIcon={
                      isAdded ? (
                        ...
                        <Add className=" w-7 h-7 fill-white" />
                      )
                    }
                    onClick={addToList}
                  >
          ...
          <div className="border-blue-500 w-full flex flex-row justify-center mt-20 gap-5">
            ...
            <div className="flex flex-col border-cyan-400 basis-4xl gap-2 ">
              ...
              <div className="flex flex-row gap-5 items-center">
                ...
                |<div>stars</div>|<div>{runtimeString || "Xh Xmin"}</div>|
                <div>2017</div>
              </div>
              <hr />
