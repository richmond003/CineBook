...
function Card({data, onClick, style}){
    return (
            ...
            //     </div>
            // </div>
            <div onClick={onClick} className={style || "rounded-xl h-70 w-50 overflow-hidden transition delay-90 duration-300 ease-in-out hover:-translate-y-1 hover:scale-109 hover:z-40"}>
                {/* <div className='h-[80%]'> */}
                    <img 
