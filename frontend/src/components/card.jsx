...
function Card({data, clickListner, style}){
    return (
            ...
            //     </div>
            // </div>
            <div onClick={clickListner} className={style || "border-2 rounded-xl h-40 w-55 overflow-hidden transition delay-90 duration-300 ease-in-out hover:-translate-y-1 hover:scale-109 hover:z-40"}>
                {/* <div className='h-[80%]'> */}
                    <img 
